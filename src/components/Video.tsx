  ...
  return (
    <div className='flex-1'>
      <div className="bg-black justify-center">
        <div className="h-full w-full-[1100px] max-h-[60vh] aspect-video"></div>
      </div>

      <div className="p-8 max-h-[1100px] mx-auto ">
        <div className="flex items-start gap-16">
          <div className="flex-1">
            <h1 className="text-2xl font-bold">Aula 1 abertura ignite</h1>
            ...
            da aplicação e integrando a API GraphQL gerada pela plataforma no nosso front-end utilizando Apollo
            Client.
            </p>
          </div>
